...
# 6. Extra function to get ratio slopes from fits for two functional groups together.
# -----------------------------------------------------------------------------------

# This can be done either for density ratios or total production ratios.
